        ...
        <div className="grid grid-cols-3 gap-5 mt-10">
          <div className="relative h-[800px] overflow-auto">
            ...
            <div className="space-y-3">
              {pendingTask && pendingTask.map(item => <TaskCard key={item.id} task={item} />)}
            </div>
          </div>
          <div className="relative h-[800px] overflow-auto">
            <div className="flex sticky top-0 justify-between bg-[#D3DDF9] p-5 rounded-md mb-3">
            ...
            <div className="space-y-3">
              {runningTask && runningTask.map(item => <TaskCard key={item.id} task={item} />)}
            </div>
          </div>
          <div className="relative h-[800px] overflow-auto">
            <div className="flex sticky top-0 justify-between bg-[#D3DDF9] p-5 rounded-md mb-3">
            ...
            <div className="space-y-3">
              {doneTask && doneTask.map(item => <TaskCard key={item.id} task={item} />)}
            </div>
          </div>
        </div>
      </div>
